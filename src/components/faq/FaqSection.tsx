            ...
            <main className="container mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                        Find answers to common questions about Rate My Bite, our review process, and how we help you discover amazing
                        restaurants.
                    </p>
                </div>
                ...
                <div className="max-w-4xl mx-auto mb-12">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center">
                        <Badge
                            ...
                            className={`cursor-pointer px-4 py-2 ${selectedCategory === "all" ? "bg-primary hover:bg-primary/90" : "hover:bg-primary/90 "
                                }`}
                        ...
                        {faqCategories.map((category) => (
                            <Badge
                                ...
                                className={`cursor-pointer px-4 py-2 flex  items-center gap-2 ${selectedCategory === category.id ? "bg-primary hover:bg-primary/90" : "hover:bg-primary/90"
                                    }`}
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-start gap-4 flex-1">
                                                        ...
                                                        <div className="flex-1">
                                                            <h3 className="font-semibold text-gray-900 mb-1 text-left">{faq.question}</h3>
                                                            <Badge variant="outline" className="text-xs">
                                                                {category?.title}
                                                            </Badge>
                                                        </div>
                ...
                <Card className="max-w-4xl mx-auto mt-16 bg-gradient-to-r from-orange-500 to-red-500 text-white">
                    <CardContent className="p-8 text-center">
                        ...
                        <p className="text-lg mb-6 opacity-90">
                            Can&apos;t find what you&apos;re looking for? Our team is here to help you with any questions about TasteGuide.
                        </p>
                ...
                <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-3 gap-6">
                    ...
                    <Card className="text-center p-6 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-gray-600 text-sm">We currently cover the metropolitan area and surrounding regions.</p>
                    </Card>
                    ...
                    <Card className="text-center p-6 hover:shadow-lg transition-shadow">
                        ...
                        <p className="text-gray-600 text-sm">
                            Each restaurant is visited multiple times before we publish our review.
                        </p>
                    </Card>
                </div>
            </main>
