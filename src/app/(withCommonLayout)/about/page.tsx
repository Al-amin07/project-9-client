...
const teamMembers = [
  {
    ...
    specialties: ["Fine Dining", "International Cuisine", "Wine Pairing"],
  },
  {
    name: "Marcus Chen",
    ...
    specialties: ["Street Food", "Asian Cuisine", "Budget Eats"],
  },
  {
  ...
  },
  {
    ...
    specialties: ["Food Photography", "Restaurant Ambiance", "Visual Storytelling"],
  },
]
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We&apos;re passionate food enthusiasts dedicated to helping you discover the best dining experiences in your
            city. From hidden gems to fine dining establishments, we taste it all so you don&apos;t have to guess.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <Card key={index} className="text-center cursor-pointer p-6 hover:shadow-lg transition-shadow">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                At Rate My Bite, we believe that great food brings people together and creates lasting memories. Our
                mission is to be your trusted companion in discovering exceptional dining experiences that match your
                taste, budget, and occasion.
              </p>
              <p>
                We go beyond just rating restaurants – we tell the story behind each dish, the passion of the chefs, and
                the atmosphere that makes each place special. Our detailed reviews help you make informed decisions
                about where to spend your precious dining moments.
              </p>
              <p>
                Whether you&apos;re looking for a romantic dinner spot, a family-friendly restaurant, or the best late-night
                eats, we&apos;ve got you covered with honest, detailed, and helpful reviews.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  We provide honest, unbiased reviews based on real dining experiences. No paid promotions, just genuine
                  recommendations.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  We maintain the highest standards in our reviews, visiting each restaurant multiple times to ensure
            ...
            <Card className="text-center p-8 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  We&apos;re building a community of food lovers who share their experiences and help each other discover
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {teamMembers.map((member, index) => (
              <Card key={index} className="overflow-hidden py-0 hover:shadow-lg transition-shadow">
                ...
                <CardContent className="px-4 pb-4">
                  ...
                  <p className="text-gray-600 line-clamp-2 text-sm mb-3 leading-relaxed">{member.bio}</p>
