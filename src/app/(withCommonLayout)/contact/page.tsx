...
import { MapPin, Phone, Mail, Clock, Send, MessageSquare, Users, Camera, Utensils } from "lucide-react"
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Have a restaurant recommendation? Want to collaborate? Or just want to say hello? We&lsquo;d love to hear from
            you! Reach out to our team of food enthusiasts.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">hello@tasteguide.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 text-sm mb-4">
                  Stay updated with our latest reviews and food discoveries on social media.
                </p>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6">
              <h3 className="font-semibold text-gray-900 mb-2">How do you choose restaurants to review?</h3>
              <p className="text-gray-600 text-sm">
                We select restaurants based on community recommendations, new openings, trending spots, and hidden gems
                we discover during our food adventures.
              </p>
            </Card>

            <Card className="p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Do you accept paid reviews?</h3>
              <p className="text-gray-600 text-sm">
                No, we maintain complete editorial independence. All our reviews are unbiased and based on genuine
                dining experiences that we pay for ourselves.
              </p>
            </Card>

            <Card className="p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Can restaurants request a review?</h3>
              <p className="text-gray-600 text-sm">
                While restaurants can suggest themselves for review, we cannot guarantee coverage. We prioritize based
                on our editorial calendar and community interest.
              </p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                We revisit popular restaurants annually or when significant changes occur (new chef, menu overhaul,
                etc.) to ensure our reviews remain current and accurate.
              </p>
            </Card>
          </div>
        </div>
